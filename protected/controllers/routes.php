...
$app->post('/rekomendasi', function ($request, $response, $args) {
    ...
    if (!isset($_POST['pertimbangan'])) {
        ...
        $bobot = [
            1 => ['kriteria' => 'Performa Batasan', 'nilai' => $_POST['pertimbangan']['batasan_performa']/10*$tot],
            2 => ['kriteria' => 'Pengunjung', 'nilai' => $_POST['pertimbangan']['pengunjung']/10*$tot],
            3 => ['kriteria' => 'Biaya', 'nilai' => $_POST['pertimbangan']['biaya']/10*$tot],
            4 => ['kriteria' => 'Keahlian Teknis', 'nilai' => $_POST['pertimbangan']['keahlian_teknis']/10*$tot],
        ];
    }
